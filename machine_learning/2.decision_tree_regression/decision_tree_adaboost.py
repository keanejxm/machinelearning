...
"""
:author: keane
:file  decision_tree_adaboost.py
:time  2023/11/2 15:32
:desc  自适应增强决策树
"""
import pandas as pd
...
# model_tree = st.DecisionTreeRegressor(max_depth=6)

# 集成学习
# model = se.AdaBoostRegressor(model_tree, n_estimators=400, random_state=7)

# GDBT
model = se.GradientBoostingRegressor(max_depth=6,n_estimators=400,random_state=7)
